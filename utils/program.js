...
export const getTicketPrice = (lottery) => {
    return new BN(lottery.ticketPrice).div(new BN(LAMPORTS_PER_SOL)).toString();
};

export const getTime = (time) => {
    const localtime = moment.unix(new BN(time)).format("HH:mm DD-MM-YYYY ");
    return localtime;
};
